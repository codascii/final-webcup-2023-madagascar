...
import Porfessional from "../common/Porfessional";
import Project from "../common/Project";
import Qualified from "../common/Qualified";
import QualifiedTwo from "../common/QualifiedTwo";
import { factFour, factOne, factThree, factTwo } from "./code";

const BlocksFactMain = () => {
  return (
    <BlockMain>
      <div className="common__body">
        <h2 className="cmn__title">Fact</h2>
        ...
        <div className="common__body__section pb__60">
          ...
          <div className="tab-content" id="pills-tabContentre">
            ...
            >
              {/* Code */}
              <Code code={factOne} language="javascript" />
            </div>
          </div>
        </div>
        ...
        <div className="common__body__section pb__60">
          ...
          <div className="tab-content" id="pills-tabContent">
            ...
            >
              {/* Code */}
              <Code code={factTwo} language="javascript" />
            </div>
          </div>
        </div>
        ...
        <div className="common__body__section pb__60">
          ...
          <div className="tab-content" id="pills-tabContent3">
            ...
            >
              {/* Code */}
              <Code code={factThree} language="javascript" />
            </div>
          </div>
        </div>
        ...
        <div className="common__body__section pb__60">
          ...
          <div className="tab-content" id="pills-tabContent4">
            ...
            >
              {/* Code */}
              <Code code={factFour} language="javascript" />
            </div>
          </div>
        </div>
      </div>
